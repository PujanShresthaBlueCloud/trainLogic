          ...
          <div className="text-center lg:px-20 px-4 pt-12">
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              ...
              <div className="flex items-start justify-center">
                <form onSubmit={handleSubmit} className="w-full max-w-md bg-white rounded-xl p-6 shadow-sm" aria-label="Contact form">
                  ...
                  <label className="block mb-4">
                    ...
                    <p className="text-xs text-gray-500 mb-1">We will call you in 10 sec</p>
                    <span className="text-sm font-medium block mb-1">When should we call you? <span className="text-red-500">*</span></span>
                    <input
                      aria-label="Phone number"
                      placeholder="xxxx xxx xxx"
                      value={form.phone}
