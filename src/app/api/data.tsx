...
export const PaymentImage = [
  {
    ...
    title: "Build & Train",
    details:
      "We train the AI using your business info, FAQs, and workflows.",
  },
  {
    image: "/images/benefit/contact.svg",
    title: "Test & Launch",
    details:
      "You test it — we refine and go live.",
  },
  {
    image: "/images/benefit/bank.svg",
    title: "Average setup time",
    details:
      "2–4 weeks (even faster with our express option).",
  },
];
...
export const footerLinks: { link: string, name: string }[] = [
  ...
  {
    link: "#services", name: "AI voice agents"
  },
  {
